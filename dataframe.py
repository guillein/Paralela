...
class DataFrame(PandasMapOpsMixin, PandasConversionMixin):
    ...
    def __plot_poly(self, ax, poligonos, color, **kwargs):
        ...
        if isinstance(color, str):
            cjto = PatchCollection([PolygonPatch(poli) for poli, _ in poligonos], color = color, **kwargs)
        elif color != False:
    ...
    def __plot_point(self, ax, puntos, color, **kwargs):
        ...
        if isinstance(color, str):
            ...
            ax.scatter([p.x for p, _ in puntos], [p.y for p, _ in puntos], color = color, **kwargs)
    ...
    def __plot_linestring(self, ax, lineas, color, **kwargs):
        ...
        if isinstance(color, str):
            # Un solo color para el plot
            cjto = LineCollection([linea for linea, _ in lineas ], color = color, **kwargs)
        elif color != False:
