...
class DataFrame(PandasMapOpsMixin, PandasConversionMixin):
    ...
    def plot_bar(self, x, grosor = 0.1):
        # Hace un diagramas de barras, máximo dos barras por valor de x
        ...
        nombres_cols = self._schema.names
        
        # Eliminamos la columna del eje x de los nombres
        try:
            nombres_cols.remove(x)
        except:
            raise("x debe ser el nombre de alguna columna del DF")
        
        # Cogemos el número de barras por valor de x
        num_barras = len(self._schema.names) - 1
