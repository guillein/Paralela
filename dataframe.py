...
class DataFrame(PandasMapOpsMixin, PandasConversionMixin):
    ...
    def plot(self, ax = False, **kwargs):
        ...
        # Comprobamos si el parámetro color es una columna de colores o un color (str)
        if 'color' in kwargs.keys() and not isinstance(kwargs['color'], str):
            kwargs['color'] = kwargs['color'].rdd.flatMap(lambda x : x).collect()
